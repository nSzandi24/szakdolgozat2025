...
const varosiparkScenes = [
    ...
    {type:'narrative', image: 'pictures/characters/lucas.png', text:'Ez a kendő a William báró címerét tartalmazza. Lehet a szolgáló nő a családnak dolgozott.', location: 'Báró birtoka', nextScene: 8},
    {type:'narrative', image: 'pictures/characters/lucas.png', text:'A gyümölcsök még frissnek tűnnek. Lehet a piacról jött éppen hazafele mikor megtámadták.', location: 'Piac', nextScene: 8},
    ...
    {type:'narrative', image: 'pictures/characters/lucas.png', text:'Ez a tárgy nem érdekes a nyomozás ügyében.', nextScene: 8},
    {type:'narrative', image: 'pictures/characters/lucas.png', text:'Ez a tárgy nem érdekes a nyomozás ügyében.', nextScene: 8},
    {type:'narrative', image: 'pictures/characters/lucas.png', text:'Ebben az esetben hogyha nincs már szükség rám akkor visszatérnék az őrsre.', location: 'Rendőrség', nextScene: 6, condition: 'lucasAvailable'},
