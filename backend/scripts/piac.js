...
const piacScenes = [
    ...
    {type:'evidence_choices', prompt:'Melyik nyomról kérdezel?', image:'pictures/characters/piaci_arus.png', requiredItem: 'Gyümölcsök', choices:[
        {id:'gyumolcsok', label:'Gyümölcsök', nextScene: 30, requiresItem: 'Gyümölcsök'},
        {id:'kalapacs', label:'Kalapács', nextScene: 34, requiresItem: 'Kalapács'},
        {id:'kendo', label:'Kendő', nextScene: 38, requiresItem: 'Kendő'},
